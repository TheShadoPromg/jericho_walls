...
{
    public class ReverseProxyPublicMiddleware
    {
        private static readonly HttpClient _httpClient = new HttpClient();
        private readonly RequestDelegate _nextMiddleware;

        public ReverseProxyPublicMiddleware(RequestDelegate nextMiddleware)
        {
        ...
        public async Task Invoke(HttpContext context,
                                 ...
                                 ILogger<ReverseProxyPublicMiddleware> logger)
        {
            var serviceName = context.Request.Query["service"];
            var accessKey = context.Request.Query["access_key"];
